...
static void makeContextCurrentNSGL(_GLFWwindow* window)
{
    ...
    if (window)
        [window->context.mgl.object makeCurrentContext];
    else
...
static void swapBuffersNSGL(_GLFWwindow* window)
{
    ...
    {
        int interval = 0;
        [window->context.mgl.object getValues:&interval
    ...
    [window->context.mgl.object flushBuffer];
...
static void swapIntervalNSGL(int interval)
{
    ...
    if (window)
    {
        [window->context.mgl.object setValues:&interval
                                  forParameter:NSOpenGLContextParameterSwapInterval];
    }
...
static void destroyContextNSGL(_GLFWwindow* window)
{
    ...
    [window->context.mgl.pixelFormat release];
    window->context.mgl.pixelFormat = nil;

    [window->context.mgl.object release];
    window->context.mgl.object = nil;
...
#undef setAttrib
    ...
    window->context.mgl.pixelFormat =
        [[NSOpenGLPixelFormat alloc] initWithAttributes:attribs];
    if (window->context.mgl.pixelFormat == nil)
    {
        _glfwInputError(GLFW_FORMAT_UNAVAILABLE,
    ...
    window->context.mgl.object =
        [[NSOpenGLContext alloc] initWithFormat:window->context.mgl.pixelFormat
                                   shareContext:share];
    if (window->context.mgl.object == nil)
    {
        _glfwInputError(GLFW_VERSION_UNAVAILABLE,
    ...
    {
        GLint opaque = 0;
        [window->context.mgl.object setValues:&opaque
...
GLFWAPI id glfwGetNSGLContext(GLFWwindow* handle)
{
    ...
    return window->context.mgl.object;
}
