...
void getMacOSDefaults(GLMContext glm_ctx)
{
    ...
    glGetIntegerv(GL_MAX_COMPUTE_WORK_GROUP_COUNT,&glm_ctx->state.var.max_compute_work_group_count);
    glGetIntegerv(GL_MAX_COMPUTE_WORK_GROUP_SIZE,&glm_ctx->state.var.max_compute_work_group_size);
