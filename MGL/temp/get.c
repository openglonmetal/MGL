...
//  mgl
//
//  Created by Michael Larson on 11/9/21.
//
...
static void mglGet(GLMContext ctx, GLenum pname, GLuint type, void *data)
{
    switch(pname)
    {
        ...
        case 0x91BE: RET_TYPE_VAR(type, max_compute_work_group_count); break; // GL_MAX_COMPUTE_WORK_GROUP_COUNT
        case 0x91BF: RET_TYPE_VAR(type, max_compute_work_group_size); break; // GL_MAX_COMPUTE_WORK_GROUP_SIZE
