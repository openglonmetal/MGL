...
bool bindVertexBuffer(GLMContext ctx, GLuint vaobj, GLsizei bindingindex, GLuint buffer, GLintptr offset, GLsizei stride)
{
    VertexArray *vao;
...
void mglBindVertexBuffer(GLMContext ctx, GLsizei bindingindex, GLuint buffer, GLintptr offset, GLsizei stride)
{
...
void mglBindVertexBuffers(GLMContext ctx, GLsizei first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizei *strides)
{
    ERROR_CHECK_RETURN(ctx->state.vao, GL_INVALID_OPERATION);
...
void mglVertexArrayVertexBuffer(GLMContext ctx, GLuint vaobj, GLsizei bindingindex, GLuint buffer, GLintptr offset, GLsizei stride)
{
    if (vaobj)
    {
...
void mglVertexArrayVertexBuffers(GLMContext ctx, GLuint vaobj, GLsizei first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizei *strides)
{
    ERROR_CHECK_RETURN(ctx->state.vao, GL_INVALID_OPERATION);
    ERROR_CHECK_RETURN(first + count < MAX_BINDABLE_BUFFERS, GL_INVALID_VALUE);
    ERROR_CHECK_RETURN(buffers, GL_INVALID_VALUE);
